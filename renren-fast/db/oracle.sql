...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES (27, 1, '参数管理', 'sys/zwf.mymall.gateway.config', 'sys:zwf.mymall.gateway.config:list,sys:zwf.mymall.gateway.config:info,sys:zwf.mymall.gateway.config:save,sys:zwf.mymall.gateway.config:update,sys:zwf.mymall.gateway.config:delete', 1, 'zwf.mymall.gateway.config', 6);
